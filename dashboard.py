...
metrics = ['Cash', 'Total Equity', 'Total value', 'Total Realized PnL', 'Total Unrealized PnL', 'Total PnL', 'Total commission', 'Exposure', 'Initial Capital']
...
st.subheader(f"💼 Open Positions {open_positions_df.shape[0]}")
